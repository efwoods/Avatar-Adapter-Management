...
I need persistence for the adapters and the adapter training documents similar to the persistence endpoints in the following routes. The adapters are persisted using the following s3 persistence structure:
